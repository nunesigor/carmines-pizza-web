...
$email_remetente = "carminespizzadowntown@gmail.com";
$email_destinatario = "carminespizzadowntown@gmail.com";

$email_reply = "$email";
$email_assunto = "Carmines Pizza email contact site";
...
if (!$captcha_data) {
    echo "Confirm the captcha, please.<br><a href='http://carminespizzadallas.com/#contact'>Back</a>";
    exit;
}

$postdata = http_build_query(
    array(
        'secret' => '6Lcfzj0UAAAAAKxWIMvI7zuU67lV4SpsVs4aPTB4',
...
if ($resposta.success){
    if (mail($email_destinatario, $email_assunto, nl2br($email_conteudo), $email_headers)) {
        echo "</b>E-Mail sended. Thank's!</b><br><a href='http://carminespizzadallas.com/'>Back</a></p>";
    } else {
        echo "</b>Error to E-Mail. Sorry!</b><br><a href='http://carminespizzadallas.com/'>Back</a></p>";
    }
} else {
